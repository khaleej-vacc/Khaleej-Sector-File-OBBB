...
def main():
    ...
    targets = [
        ('Maps', 'OBBB/Plugins/GRplugin/GRpluginMaps.txt', ['regions.txt', 'geo.txt', 'freetext.txt', 'nets.txt'], add_colours_and_definitions),
        ('Stands', 'OBBB/Plugins/GRplugin/GRpluginStands.txt', ['stands.txt'], add_stand_groups),
    ]
